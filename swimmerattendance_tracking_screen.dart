...
class SwimmerAttendanceScreen extends StatefulWidget {
  final String swimmerId;
  final String swimmerName;

  const SwimmerAttendanceScreen({
    super.key,
  ...
  @override
  State<SwimmerAttendanceScreen> createState() => _SwimmerAttendanceScreenState();
}

class _SwimmerAttendanceScreenState extends State<SwimmerAttendanceScreen> {
  ...
  List<FlSpot> _buildChartSpots(List<QueryDocumentSnapshot> records) {
  ...
  Widget build(BuildContext context) {
    ...
    print('=== DEBUG: Swimmer Attendance Screen ===');
    print('Swimmer ID: ${widget.swimmerId}');
    print('Swimmer Name: ${widget.swimmerName}');
    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          print('=== DEBUG: Attendance Documents ===');
